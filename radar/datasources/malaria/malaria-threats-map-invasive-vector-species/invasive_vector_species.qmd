...
-   When used in conjunction with other data sources such as climate projections, land cover or population density data, the location of the invasive species collected can be used to model population dynamics, as done by [Da Re, D. et al. (2022](https://parasitesandvectors.biomedcentral.com/articles/10.1186/s13071-022-05414-4)) in their exploration of invasive *Aedes* species.
