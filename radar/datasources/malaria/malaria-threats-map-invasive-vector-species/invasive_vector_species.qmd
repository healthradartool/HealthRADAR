...
- To access the data, click on the [link](https://apps.who.int/malaria/maps/threats) to access the [Malaria Threats Map](https://apps.who.int/malaria/maps/threats/) page. 
...
![Figure 1: Distribution of *Anopheles stephensi* in Kenya for 2022-2024.](images/distributionn_of_anopheles_stephensi_kenya.png){fig-align="left"}
...
![Figure 2: The occurrence of all invasive species from 2010 – 2024.](images/occurance_of_invasive_species.png){fig-align="left"}
...
![Figure 3: Sample of the summary dashboard that can be created using the distribution data.](images/summary_dashboard.png){fig-align="left"}
...
Data on invasive mosquito vector species can be used in a range of malaria modelling applications. It can be used to project the spread of disease if transmission efficiency of the invasive vector differs to the native vector, or their combined effects can inform the overall vectorial capacity in a given context. When used in conjunction with other data sources such as climate projections, land cover or population density data, the location of the invasive species collected can be used for spatial risk mapping and/or to forecast further invasions of the species. These findings can also be used as inputs for models that evaluate intervention impact, as far as targeted vector control and changes in their effectiveness due to the presence of invasive species.
