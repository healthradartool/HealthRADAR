...
To learn more about the data, visit the [Malaria Threats Map](https://apps.who.int/malaria/maps/threats/) website.
...
![Table 1. The pyrethroid resistance intensity data for KwaZulu-Natal in South Africa (2016)](images/table_1_pyrethroid_resistance.png){fig-align="left"}
...
![Figure 1. The distribution of pyrethroid resistance in South Africa.](images/distribution_of_pyrethroid_resistance_in_south_africa.jpg){fig-align="left"}
...
![Figure 2. The distribution of pyrethroid resistance on the African continent.](images/distribution_of_pyrethroid_resistance_on_the_african_contitnent.png){fig-align="left"}
