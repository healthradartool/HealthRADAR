...
For the age-structured malaria model below, we use data on ITN usage among children from the UNICEF dataset described above. For the rest of the population, we simulate ITN coverage.
