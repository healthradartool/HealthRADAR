...
Many malaria control interventions are targeted at vulnerable populations, specifically pregnant women and children under the age of five. Similarly, in some countries Insecticide Treated Nets (ITNs) are distributed through antenatal clinics to increase access and usage of prevention methods in these groups.
...
For the age-structured malaria model below, we use data on ITN usage amongst children from the UNICEF dataset. For the rest of the population, we simulate coverage net data.
...
Consequently, the force of infection $lambda-c$ ($\lambda_c$) in children under the age of five years, i.e. the rate at which they are exposed to an infectious vector, will be higher than that adults. This is due to their increased susceptibility to infection, and shorter span of partial immunity.
