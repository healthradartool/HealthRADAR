...
scale_colour_manual_health_radar <- function() {
  scale_colour_manual(values = theme_health_radar_colours) # Apply the colours for 'colour' aesthetic
}

# Function to apply generic manual fill scale for discrete variables (fill)
scale_fill_manual_health_radar <- function() {
  scale_fill_manual(values = theme_health_radar_colours) # Apply the colours for 'fill' aesthetic
}
