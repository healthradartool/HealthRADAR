...
ggplot(data = rwanda_data) +
  ...
  labs(
    title = "Reported malaria cases Rwanda (by province) 1st quarter (2022)",
  ...
  geom_sf_text(
    aes(label = name, color = ifelse(cases > mean(cases), "black", "white")), 
    size = 3
  ) +  # Conditional text color
  scale_color_identity() +  
  theme(plot.caption.position = "plot")  # Keep the caption outside the plot area
```
