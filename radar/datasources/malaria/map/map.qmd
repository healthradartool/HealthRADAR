...
represented in the SEIRS (Susceptible, Exposed, Infected, Recovered)
...
The code below demonstrates how to plot model outputs. In this example,
we plot daily incidence from 2013 to 2022. The choice of model output to
plot depends on the goals of the modeller or stakeholders. For instance,
plotting incidence for this model may highlight the estimated impact of
...
therefore do not reflect actual impacts or real case numbers.
