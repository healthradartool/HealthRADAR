...
modelled_incidence_rate <- data.frame(
  ...
  labs(title = "Malaria incidence rate in Angola from 2000 to 2022",
       ...
       caption = stringr::str_wrap("The calibrated model output projects incidence close to the WHO estimates. The gray ribbon represents the model's uncertainty, and its overlap with the confidence intervals of the data indicates a good fit. Source: Model output & World Malaria Report 2023, Annex 4-F.")) +
  theme_health_radar()
```
