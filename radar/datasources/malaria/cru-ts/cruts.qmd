...
ggplot() +
  ...
  labs(
    ...
    x = "Longitude", 
    y = "Latitude",
    caption = str_wrap("Spatial plot of long term mean annual total rainfall (mm/year) for the period 1991-2020. Source: CRU TS 4.08", width = 75)
  )
...
ggplot() +
  ...
  labs(
    ...
    x = "Longitude", 
    y = "Latitude",
    caption = str_wrap("Spatial plot of long term mean monthly average temperature (Celsius) for the period 1991-2020. Source: CRU TS 4.08", width = 75)
  )
...
ggplot() +
  ...
  labs(
    ...
    x = "Month",
    caption = str_wrap("Monthly climatology of total rainfall (bars) and mean temperature (line) for Bulawayo, averaged over the period 1991-2020. Source: CRU TS 4.08", width = 75)
  )
...
ggplot() +
  ...
  labs(
    ...
    x = "Year",
    caption = str_wrap("Timeseries of monthly total rainfall (bars) and number of stations used in the interpolation (line) for a gridcell over Bulawayo. Source: CRU TS 4.08", width = 75)
  )
...
ggplot() +
  ...
  labs(
    ...
    x = "Year",
    caption = str_wrap("Timeseries of monthly mean temperature (bars) and number of stations used in the interpolation (line) for a gridcell over Bulawayo. Source: CRU TS 4.08", width = 75)
  )
