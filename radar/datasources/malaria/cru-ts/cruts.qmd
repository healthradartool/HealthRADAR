...
ggplot() +
  ...
  labs(
    title = "Average Mean Surface Air Temperature values in Bulawayo from 2000 to 2020",
    x = "Year",
...
df |> 
  ...
  labs(title = "Mosquito vector and human host Populations over time", 
       ...
       y = "Population size",
       colour = "Population",
       caption = str_wrap("Changes in the total mosquito population mimic seasonal changes in temperature and rainfall values over time, with peaks in the summer months. The human population remains constant in this example, as it is not driven by environmental conditions. The higher rainfall values in 2017 are also reflected in the mosquito population. Source: Model output"))
