---
title: "Precipitation"
image: "img/articles-precipitation.png"
...
There are a number of providers of precipitation data. Here are some specific examples of data sources for monthly precipitation data:

* Global Precipitation Climatology Centre (GPCC): The GPCC is a data center that provides global monthly precipitation data. The data is collected from ground-based gauges and satellites.
* Climate Prediction Center (CPC): The CPC is a data center that provides monthly precipitation data for the United States. The data is collected from ground-based gauges and satellites.
* National Centers for Environmental Prediction (NCEP): The NCEP is a data center that provides global monthly precipitation data. The data is collected from ground-based gauges and satellites.
...
* [Global Precipitation Climatology Centre (GPCC)](/datasets/precipitation_kmdn.html)