...
A great way to contribute is to report issues, either found when working on a pull request or when using Health RADAR. We have [issue templates](https://github.com/healthradartool/HealthRADAR/issues) to help you report feature requests or bugs. Please use them when reporting an issue. We also have a [report issues](/issues.qmd) page where you can report issues if you are not familiar with GitHub.
