...
subtitle: "This guide provides detailed instructions to help you effectively contribute to the Health RADAR project."
page-layout: full
format: 
  html: 
    code-fold: false
...
A very good way to contribute is to report issues, either found when working on a pull request or when simply using Health RADAR. We have issue templates to help you report feature requests or bugs, please use them when reporting an issue. We also have a [report issues](/issues.qmd) page where you can report issues if you are not familiar with GitHub.
