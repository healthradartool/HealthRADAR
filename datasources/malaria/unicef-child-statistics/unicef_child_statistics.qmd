...
**1 - Curated Datasets from UNICEF Topic Pages **
...
**2 - Direct Access to Survey Data (DHS and MICS Programs) **
...
**3 - UNICEF Indicator Data Warehouse (SDMX) **
...
mal_dat <- readxl::read_xlsx(
    "data/Child-Health-Coverage-Database-December-2023.xlsx",
    sheet = "Long",
    skip = 3,
