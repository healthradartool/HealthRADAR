...
mal_dat |> 
  dplyr::filter(Indicator == "ITNPREG",
                Level == "National",
                `Latest Year` %in% c(2007, 2011, 2014, 2015, 2018)) |>
...
For a more detailed description of the incorporation of ITNs, see the [DHS](/radar/datasources/malaria/dhs-program/dhs.html) page. For this example, we use UNICEF-sourced data to inform an age-structured model in Zimbabwe, depicting two populations: individuals over the age of five, and children under five years old.
