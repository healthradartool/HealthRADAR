...
```
Subnational data - mean number of mosquito nets by E8 country
Each point represents the mean number of nets in a specific subregion of the country. The line represents the trend over time for each country. The shaded area represents the 95% confidence interval for the trend line.
Add brief descriptions for each one.
